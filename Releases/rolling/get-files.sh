...
if [[ -n $APPVEYOR_32bits ]]; then
    wget "https://ci.appveyor.com/api/buildjobs/$APPVEYOR_32bits/log" \
        O x32_log.txt
fi
...
wget "https://gitlab.com/claudioandre-br/JtR-CI/-/jobs/$FLATPAK/raw" \
    -O bundle_log.txt
wget "https://gitlab.com/claudioandre-br/JtR-CI/-/jobs/$FLATPAK_TEST/raw" \
    -O bundle_test.txt
